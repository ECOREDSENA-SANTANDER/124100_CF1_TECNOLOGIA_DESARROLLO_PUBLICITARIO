...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    p.mb-5 El desarrollo de una investigación debe necesariamente tener una estructura sólida, coherente y organizada. Esto, con el fin obtener la información y los resultados de la forma más eficiente posible.
    ...
    p.mb-4 El problema de investigación se define con base en la información que se desea recolectar y el origen mismo del problema, ya sea para indagar acerca de la conducta de compra de determinado producto, el nivel de participación en el mercado o las características de los canales de distribución.

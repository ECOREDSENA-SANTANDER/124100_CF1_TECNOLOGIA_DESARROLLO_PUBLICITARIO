...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    p.mb-4(data-aos="zoom-in-left") El problema de investigación se define con base en la información que se desea recolectar y el origen mismo del problema, ya sea para indagar acerca de la conducta de compra de determinado producto, el nivel de participación en el mercado o las características de los canales de distribución.
      ...
      .col-sm-12.col-lg-12.bg1.p-4
       .row.justify-content-center.align-items-center
        .col-sm-12.col-lg-2.d-none.d-lg-block
          img(src='@/assets/curso/temas/tema5/img3.svg', style="max-width: 60%; margin: auto;")
        .col-sm-12.col-lg-10
          p.mb-4.text-white.fw-bold El problema de investigación es la información básica a recolectar; por lo tanto, este debe transformarse en el objetivo general del proyecto.
